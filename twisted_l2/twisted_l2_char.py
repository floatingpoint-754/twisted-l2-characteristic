...
__all__ = ["make_phi_from_coordinates", "laplacians", "twisted_l2_characteristic", "characteristic", "get_twisted_l2_logs", "draw_seminorm"]
...
def draw_seminorm(G, cc, n, exps, rad = 1):
    """
    Constructs a matrix of values of the twisted L^2 Euler characteristic at integer points.
